...
int main(){
	...
	//empty constructor	
	std::cout<<"zero constr\n"; //print it
	Matrix<double,3> myMatrix = Matrix<double,3>();
	std::cout<<myMatrix.toString()<<"\n"; //print it

	//array constr
	std::cout<<"array constr\n"; //print it
	double init[3][3]={{1,2,9},{0,5,6},{7,3,9}};
	Matrix<double,3> myMatrix1 = Matrix<double,3>(init);
	std::cout<<myMatrix1.toString()<<"\n"; //print it

	//array constr
	std::cout<<"std::initializer_list constr\n"; //print it
	Matrix<double,3> myMatrix2 = {{1,2,9},{0,5,6},{7,3,9}};
	Matrix<double,3> myMatrix0 = {1,2,9,0,5,6,7,3,9};
	std::cout<<myMatrix2.toString()<<"\n"; //print it
	std::cout<<myMatrix0.toString()<<"\n"; //print it


	//copy constr
	std::cout<<"copy constr\n"; //print it
	Matrix<double,3> myMatrix3 = Matrix<double,3>(myMatrix2);
	...
	Vector<double,3> myVec = Vector<double,3>();	
