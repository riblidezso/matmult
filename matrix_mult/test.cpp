...
int main(){
	...
	//rowiterator
	std::cout<<"iterator row:\n"; 
	for (Matrix<double>::rowIterator it=myMatrix2.rowBegin(0);it!=myMatrix2.rowEnd(0);it++){
		std::cout<<*it<<"\t";
		}
	std::cout<<"\n"; 

	//coliterator
	std::cout<<"iterator col:\n"; 
	for (Matrix<double>::colIterator it=myMatrix2.colBegin(0);it!=myMatrix2.colEnd(0);it++){
		std::cout<<*it<<"\t";
		}
	std::cout<<"\n"; 

	//coliterator
	std::cout<<"iterator diag:\n"; 
	for (Matrix<double>::diagIterator it=myMatrix2.diagBegin();it!=myMatrix2.diagEnd();it++){
		std::cout<<*it<<"\t";
		}
	std::cout<<"\n"; 
	...
	std::cout<<(4.0*myMatrix2).toString()<<"\n";//print it
	std::cout<<(myMatrix2/0.25).toString()<<"\n";//print it
	std::cout<<((4.0*myMatrix2).equals(myMatrix2/0.25) ?  "equals" : "different")<<std::endl;
	//std::cout<<(b ? "true" : "false")<<std::endl;
	//std::cout<<(4.0*myMatrix2).equals(myMatrix2/0.25)<<"\n";//print it
